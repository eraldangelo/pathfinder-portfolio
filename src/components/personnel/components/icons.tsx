...
export const UserPlusIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.5H6a3 3 0 0 1-3-3v-1.5a4.5 4.5 0 0 1 4.5-4.5h2.25" />
        <circle cx="10.5" cy="7.5" r="3.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.5v4m2-2h-4" />
    </svg>
);

export const StaffIcon: React.FC<{ className?: string }> = ({ className = 'w-10 h-10' }) => (
